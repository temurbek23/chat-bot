...
}), define("text!templates/chat-bot/temp.html", [], function() {
...
}), define("views/temp-snippet", ["jquery", "views/snippet", "text!templates/chat-bot/temp.html", "helper/pubsub"], function(e, t, n, r) {
    return t.extend({
        initialize: function() {
...
}), define("text!templates/chat-bot/tab-nav.html", [], function() {
    return '<li><a href="#<%= id %>" data-toggle="tab"><%= title %></a></li>\n'
}), define("views/tab", ["jquery", "underscore", "backbone", "text!templates/chat-bot/tab-nav.html"], function(e, t, n, r) {
    return n.View.extend({
        tagName: "div",
        className: "tab-pane",
        initialize: function() {
...
}), define("text!templates/chat-bot/renderform.html", [], function() {
    return '<form class="form-horizontal">\n<fieldset>\n\n<%= text %>\n</fieldset>\n</form>\n'
}), define("Guid", function() {}), define("views/my-form", ["jquery", "underscore", "backbone", "views/temp-snippet", "helper/pubsub", "text!templates/chat-bot/renderform.html", "Guid"], function(e, t, n, r, i, s) {
    return n.View.extend({
        tagName: "fieldset",
        initialize: function() {
...
}), define("text!templates/chat-bot/render.html", [], function() {
    return '<h6>Rendered source of your form:</h6>\n<textarea id="render" class="render p-3"></textarea>\n'
}), define("chat-bot/chat-bot", ["jquery", "underscore", "backbone", "collections/snippets", "collections/my-form-snippets", "views/tab", "views/my-form", "text!data/input.json", "text!data/radio.json", "text!data/select.json", "text!data/buttons.json", "text!templates/chat-bot/render.html"], function(e, t, n, r, i, s, o, u, a, f, l, c, h) {
    return {
        initialize: function() {
            new s({
                title: "Input",
...
}), require(["chat-bot/chat-bot"], function(e) {
    e.initialize()
