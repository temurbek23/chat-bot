<div class="sidebar-wrapper">
	<div>
		<div class="logo-wrapper text-center">
			<a href="{{route('/')}}"><img class="img-fluid for-light" src="{{asset('assets/images/logo/chat-bot.png')}}" alt="" width="100"><img class="img-fluid for-dark" src="{{asset('assets/images/logo/logo_dark.png')}}" alt=""></a>
		</div>
			...
			<div id="sidebar-menu">
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						<label class="badge badge-success"></label><a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/dashboard' ? 'active' : '' }}" href="{{route('index')}}"><i data-feather="home"></i><span class="lan-3">{{ trans('lang.Dashboards') }}</span>
						</a>
					</li>
					<li class="sidebar-list">
						...
						<a class="sidebar-link sidebar-title {{request()->route()->getPrefix() == '/project' ? 'active' : '' }}" href="#">
							<i data-feather="box"></i><span>{{ trans('Question') }} </span>
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/project' ? 'block;' : 'none;' }}">
		                    <li><a href="{{route('projects')}}" class="{{ Route::currentRouteName()=='projects' ? 'active' : '' }}">{{ trans('Question List') }}</a></li>
		                    <li><a href="{{route('projectcreate')}}" class="{{ Route::currentRouteName()=='projectcreate' ? 'active' : '' }}">{{ trans('Question new') }}</a></li>
		                </ul>
					</li>
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{request()->route()->getPrefix() == '/users' ? 'block' : 'none;' }};">
		                    <li><a href="{{route('users.index')}}" class="{{ Route::currentRouteName()=='user-profile' ? 'active' : '' }}">Users</a></li>
		                    <li><a href="{{route('users.create')}}" class="{{ Route::currentRouteName()=='edit-profile' ? 'active' : '' }}">User Add</a></li>
		                </ul>
					</li>
