            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  ...
                  <li class="sidebar-list"><a class="sidebar-link sidebar-title link-nav {{ Route::currentRouteName()=='social-chat-bot' ? 'active' : '' }}" href="{{route('social-chat-bot')}}"><i data-feather="zap"> </i><span>{{ trans('lang.Social App') }}</span></a></li>
