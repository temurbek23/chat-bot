@extends('Cuba laravel.resources.views.layouts.authentication.master')
@section('title', 'Login')
                            ...
                            <form class="theme-form">
                                ...
                                <div class="social mt-4">
                                    <div class="btn-showcase"><a class="btn btn-light"
                                            ...
                                            LinkedIn </a><a class="btn btn-light"
                                                ...
                                                target="_blank"><i class="txt-fb"
                                                                   data-feather="facebook"></i>facebook</a></div>
                                </div>
                                <p class="mt-4 mb-0">Don't have account?<a class="ms-2" href="{{  route('sign-up') }}">Create
                                        Account</a></p>
                            </form>
                        </div>
                    </div>
