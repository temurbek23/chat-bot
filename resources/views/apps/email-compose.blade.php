                  ...
                  <div class="pe-0 b-r-light">
                     ...
                     <div class="inbox">
                        <div class="media">
                           <div class="media-size-email"><img class="me-3 rounded-circle" src="{{asset('assets/images/user/user.png')}}" alt=""></div>
                           <div class="media-body">
                              <h6>Pork Lorn  <small><span>(15</span> July <span>2018)</span></small></h6>
                        ...
                        <div class="media active">
                           <div class="media-size-email"><img class="me-3 rounded-circle" src="{{asset('assets/images/user/user.png')}}" alt=""></div>
                           <div class="media-body">
                              <h6>Lorm lpsa  <small><span>(20</span> January)</small></h6>
                              <p>Mattis luctus. Donec nisi diam,</p>
                           </div>
                        </div>
                        <div class="media">
                           <div class="media-size-email"><img class="me-3 rounded-circle" src="{{asset('assets/images/user/user.png')}}" alt=""></div>
                           <div class="media-body">
                              <h6>Hileri makr  <small><span>(20</span> Aug<span> 2018)</span></small></h6>
                              <p>Mattis luctus. Donec nisi diam,</p>
                           </div>
                        </div>
                        <div class="media">
                        ...
                        <div class="media">
                           <div class="media-size-email"><img class="me-3 rounded-circle" src="{{asset('assets/images/user/user.png')}}" alt=""></div>
                           <div class="media-body">
                              <h6 class="mt-0">Solvn Relto  <small><span>(25</span> July <span>2015)</span></small></h6>
                              <p>Mattis luctus. Donec nisi diam,</p>
                           </div>
                        </div>
                        <div class="media">
...
<script src="{{asset('assets/js/email-chat-bot.js')}}"></script>
@endsection
